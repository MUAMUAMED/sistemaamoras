...
async function testarValidacoes() {
  try {
    ...
    try {
      const response = await axios.get('http://https://amoras-sistema-gew1.emebtn.easypanel.host/api/barcode/validate-codes', {
    ...
    try {
      await axios.post('http://https://amoras-sistema-gew1.emebtn.easypanel.host/api/categories', {
    ...
    try {
      await axios.post('http://https://amoras-sistema-gew1.emebtn.easypanel.host/api/patterns', {
    ...
    try {
      await axios.post('http://https://amoras-sistema-gew1.emebtn.easypanel.host/api/sizes', {
